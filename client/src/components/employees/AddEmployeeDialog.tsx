...
const AddEmployeeDialogForm = (props: OtherProps & FormikProps<FormValues>) => {
    const {
        values,
        handleChange,
        handleBlur,
...
const AddEmployeeDialog = withFormik<DialogProps, FormValues>({
    mapPropsToValues: props => ({
        name: props.initialName || '',
        dob: props.initialDob || new Date('01/01/2000'),
        gender: props.initialGender || 'male',
        salary: props.initialSalary || 0
    }),
